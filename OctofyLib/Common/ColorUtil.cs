...
namespace OctofyLib
{
    ...
    public struct EdgeColor
    {
        ...
        /// </summary>
        public static Color GetRenderingColor(EdgeColorType edgeColorType__1, Color color__2)
        {
            Debug.Assert(color__2 != Color.Empty);
            if (edgeColorType__1 == EdgeColorType.Contrast || edgeColorType__1 == EdgeColorType.EnhancedContrast)
            {
                edgeColorType__1 = GetContrastColorType(color__2, edgeColorType__1);
            }

            float correctionFactor = 0;
            switch (edgeColorType__1)
            {
                ...
                case EdgeColorType.FullContrast:
                    {
                        return GetFullContrastColor(color__2);
                    }
            ...
            return ColorUtil.CreateColorWithCorrectedLightness(color__2, correctionFactor);
        }
        ...
        private static Color GetFullContrastColor(Color color__1)
        {
            if (color__1.GetBrightness() > s_brightnessThreshold)
            {
                return Color.Black;
            }
